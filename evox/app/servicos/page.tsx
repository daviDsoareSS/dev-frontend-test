    ...
    return (
        <>
            <div className="max-w-screen-sm">
                <h2 className="mb-4 text-4xl font-semibold text-black">Depoimentos</h2>
                <p className="mb-4 font-light text-neutral-600 lg:mb-16 sm:text-sm">Explore the whole collection of open-source web components and elements built with the utility classes from Tailwind</p>
            </div>
            <div className="flex flex-wrap justify-between">
                <div 
                    className="group relative p-6 flex flex-col gap-5 justify-center rounded-sm w-92 h-120 block bg-white shadow-md border-1 border-gray-200"
                >

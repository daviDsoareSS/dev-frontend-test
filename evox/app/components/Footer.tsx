        ...
        <footer className="bg-slate-800">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex items-center mt-4 gap-4 sm:justify-center sm:mt-0">
                    {/* TELEFONE */}
                    <Link href="tel:11949842322" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    {/* EMAIL */}
                    <Link href="davidsoares2156@gmail.com" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    {/* LINKEDIN */}
                    <Link href="https://www.linkedin.com/in/david-soares-silva-014891229/" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    {/* GITHUB */}
                    <Link href="https://github.com/daviDsoareSS" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
